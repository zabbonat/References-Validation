                ...
                <div className="flex flex-col space-y-2 mt-2">
                    ...
                    {result.exists && (
                        <div className="text-xs text-gray-600 mt-2 bg-gray-50 p-2 rounded">
                            ...
                            {/* Corrected APA - Highlighted when available */}
                            {result.correctedApa && (
                                <div className="mb-2 p-2 bg-green-50 border border-green-200 rounded text-gray-800">
                                    <span className="font-bold text-xs text-green-600 block mb-1">✓ Corrected Citation (APA):</span>
                                    {result.correctedApa}
                                </div>
                            )}

                            {/* Original APA Style Display */}
                            {result.apa && (
                            ...
                            {/* BibTeX Copy - uses corrected if available */}
